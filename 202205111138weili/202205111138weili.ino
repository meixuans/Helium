...
static const u1_t PROGMEM APPEUI[8] = {0x9C, 0xF9, 0x81, 0x60, 0x55, 0xF5, 0x41, 0xD6};
void os_getArtEui(u1_t *buf) { memcpy_P(buf, APPEUI, 8); }

// This should also be in little endian format
// These are user configurable values and Helium console permits anything
static const u1_t PROGMEM DEVEUI[8] = {0xD4, 0xF9, 0x81, 0x60, 0x68, 0x5A, 0x66, 0x99};
void os_getDevEui(u1_t *buf) { memcpy_P(buf, DEVEUI, 8); }

// This is the "App Key" in Helium. It is big-endian (msb).
static const u1_t PROGMEM APPKEY[16] = {0x78, 0xE6, 0xCA, 0x47, 0xEF, 0x94, 0x33, 0x77, 0xE4, 0xD6, 0xFF, 0x29, 0x3D, 0xD1, 0x49, 0xF7};
